...
<!-- Mirrored from template.hasthemes.com/reid/reid/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:22 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - نمونه کارها</title>
        ...
        <div class="container">
            <div class="portfolio_button">
                <div class="row">
                    <div class="col-12">
                        ...
                        <button data-filter=".company">شرکت</button>
                        <button data-filter=".computers">کامپیوترها</button>
                        <button data-filter=".general">عمومی</button>
                        <button data-filter=".hipster">هیپستر</button>
                        <button data-filter=".food">فقط غذا</button>
            ...
            <div class="row portfolio_gallery">
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers general">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio1.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio1.jpg"><i
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers food">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio2.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio2.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item company general">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio3.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio3.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers hipster">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio4.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio4.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers general food">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio5.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio5.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item company general hipster">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio7.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio7.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers company food">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio8.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio8.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item computers general Hipster">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio10.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio10.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 gird_item company general hipster food">
                    <div class="single_portfolio_inner">
                        <div class="portfolio_thumb">
                            <a href="#"><img src="assets/img/portfolio/portfolio11.jpg" alt=""></a>
                            <div class="portfolio_popup">
                                <a class="port_popup" href="assets/img/portfolio/portfolio11.jpg"><i
                                        class="fa fa-search"></i></a>
                            </div>
                            <div class="portfolio__content">
                            </div>
...
<!-- Mirrored from template.hasthemes.com/reid/reid/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:33 GMT -->
