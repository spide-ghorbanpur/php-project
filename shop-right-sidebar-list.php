...
<!-- Mirrored from template.hasthemes.com/reid/reid/shop-right-sidebar-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:11:12 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid -  لیست نوار کناری سمت راست</title>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu text-end">
                                                ...
                                                <li><a href="shop-right-sidebar-list.html"> لیست نوار کناری سمت راست</a>
                                                </li>
                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            <li>/</li>
                            <li>لیست نوار کناری سمت راست</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 text-end">
                        ...
                        <div class="shop_toolbar_wrapper">
                            <div class="shop_toolbar_btn">
                                ...
                                <button data-role="grid_list" type="button"  class="active btn-list" data-bs-toggle="tooltip" title="لیست"></button>
                            </div>
                            <div class=" niceselect_option">
                                ...
                                <form class="select_option" action="#">
                                    <select name="orderby" id="short">
                                        ...
                                        <option selected value="1">مرتب سازی بر اساس رتبه بندی متوسط</option>
                                        ...
                                        <option value="6">نام محصول: z</option>
                                    </select>
                                </form>
                         ...
                         <div class="row shop_wrapper grid_list">
                            <div class="col-12 text-end">
                                <div class="single_product">
                                    ...
                                    <div class="product_content grid_content">
                                        <h3><a href="product-details.php">بلوتوث قابل حمل مارشال</a></h3>
                                        <span class="current_price">60.00 پوند</span>
                                        <span class="old_price">86.00 پوند</span>
                                    </div>
                                    ...
                                    <div class="product_content list_content">
                                        ...
                                        <div class="product_desc">
                                            <p class="mt-3">لورم ایوم متن ساختگی با تولید از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و در ستون و سطرآنان است که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. لورم ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ با استفاده از طراحان گرافیک است.لورم ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و در ستون و سطرآنان است که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. لورم ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ با استفاده از طراحان گرافیک است.لورم ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و در ستون و سطرآنان است که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. لورم ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ </p>
                                        </div>
                            ...
                            <div class="col-12 text-end">
                                <div class="single_product">
                                    ...
                                    <div class="product_content grid_content">
                                        <h3><a href="product-details.php">بلوتوث قابل حمل</a></h3>
                                        <span class="current_price">60.00 پوند</span>
                                    </div>


                                    <div class="product_content list_content text-end">
                                        <h3><a href="product-details.php">بلوتوث قابل حمل</a></h3>
                                        <div class="product_ratting">
                                            <ul>
                                                <li><a href="#"><i class="fa fa-star"></i></a></li>
                                        ...
                                        <div class="product_price">
                                            <span class="current_price">60.00 پوند</span>
                                            <span class="old_price">60.00 پوند</span>
                                        </div>
                                        <div class="product_desc">
                                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.صنعت چاپ و با استفاده از طراحان گرافیک است. صنعت چاپ و با استفاده از طراحان گرافیک است.صنعت چاپ و با استفاده از طراحان گرافیک است.صنعت چاپ و با استفاده از طراحان گرافیک است.صنعت چاپ و با  ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ ایوم متن ساختگی با تولید آسان نامفهوم از صنعت چاپ استفاده از طراحان گرافیک است. صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 text-end">
                        ...
                        <div class="sidebar_widget ">
                            ...
                            <div class="widget_list widget_categories text-end">
                                <h2>دسته بندی محصولات</h2>
                                <ul>
                                    <li class="p-2"><a href="#">دسته بندی 1 <span>6</span></a></li>
                                    <li class="p-2"><a href="#"> دسته بندی 2 <span>10</span></a> </li>
                                    <li class="p-2"><a href="#">دسته بندی 3 <span>4</span></a> </li>
                                    <li class="p-2"><a href="#"> دسته بندی 4 <span>4</span></a> </li>
                                    <li class="p-2"><a href="#">دسته بندی 5 <span>3</span></a> </li>
                                </ul>
                            </div>
                            ...
                            <div class="widget_list widget_categories text-end">
                                <h2>سازنده</h2>
                                <ul>
                                    <li class="p-2"><a href="#">کالوین کلاین <span>6</span></a> </li>
                                    <li class="p-2"><a href="#"> شانل <span>10</span></a> </li>
                                    <li class="p-2"><a href="#">کریستین دیور <span>4</span></a> </li>
                                    <li class="p-2"><a href="#"> فرگامو <span>4</span></a> </li>
                                    <li class="p-2"><a href="#">هرمس <span>10</span></a> </li>
                                    <li class="p-2"><a href="#">لوئیس ویتون<span>8</span></a> </li>
                                    <li class="p-2"><a href="#">تامی هیلفیگر <span>7</span></a> </li>
                                    <li class="p-2"><a href="#">ورساچه <span>6</span></a> </li>

                                </ul>
                            </div>
                            <div class="widget_list widget_categories">
                                <h2>بر اساس رنگ انتخاب کنید</h2>
                                <ul>
                                    <li><a href="#">مشکی <span>6</span></a> </li>
                                    <li><a href="#"> آبی <span>10</span></a> </li>
                                    <li><a href="#">رنگ قهوه ای <span>4</span></a> </li>
                                    <li><a href="#"> سبز <span>4</span></a> </li>
                                    <li><a href="#">رنگ صورتی <span>7</span></a> </li>
                                    <li><a href="#">سفید<span>8</span></a> </li>
                                    <li><a href="#">زرد <span>5</span></a> </li>
                            ...
                            <div class="widget_list tag-cloud">
                                ...
                                <div class="tag_widget">
                                    <ul>
                                        <li><a href="#">کرم ها</a></li>
                                        <li><a href="#">مداد ابرو</a></li>
                                        <li><a href="#">خط چشم</a></li>
                                        <li><a href="#">سایه چشم</a></li>
                                        <li><a href="#">لوسیون ها</a></li>
                                        <li><a href="#">ریمل</a></li>
                                        <li><a href="#">روغن ها</a></li>
                                        <li><a href="#">پودرها</a></li>
                                        <li><a href="#">شامپوها</a></li>
                                    </ul>
                                </div>
                            </div>
