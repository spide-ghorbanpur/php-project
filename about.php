...
<!-- Mirrored from template.hasthemes.com/reid/reid/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:33 GMT -->
...
<body>
    ...
    <div class="breadcrumbs_area other_bread text-end">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <div class="about_section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 text-end mt-5">
                    <div class="about_content">
                        <h1>به فروشگاه رید خوش آمدید!</h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.
                            ...
                            ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single_counterup">
                        ...
                        <div class="counter_info text-end">
                            <h2 class="counter_number">2170</h2>
                            <p>مشتریان خوشحال</p>
                        </div>
                        <div class="counter_img mx-4">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="progressbar_inner">
                        <h2 class="text-end">ما مهارت هایی برای نشان دادن داریم</h2>
                        <div class="progress_skill one">
                            ...
                            <span class="progress_discount">۶۰%</span>
                        </div>
                        <div class="progress_skill two">
                            <div class="progress">
                                <div class="progress-bar about_prog wow fadeInRight" data-wow-duration="0.8s"
                            ...
                            <span class="progress_discount">۹۰%</span>
                        </div>
                        <div class="progress_skill three">
                            ...
                            <span class="progress_discount">۷۰%</span>
                        </div>
                        <div class="progress_skill four">
                            ...
                            <span class="progress_discount">۸۰%</span>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from template.hasthemes.com/reid/reid/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:40 GMT -->
