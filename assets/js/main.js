(function ($) {
    ...
    /*TODO:Shariyat Code ===> additional windows resize*/
    const zoom1 = function (){
        $("#zoom1").elevateZoom({
            gallery:'gallery_01',
            responsive : true,
            cursor: 'crosshair',
