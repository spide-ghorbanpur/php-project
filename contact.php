...
<!-- Mirrored from template.hasthemes.com/reid/reid/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:43 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - تماس با ما</title>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 text-end">
                    <div class="contact_message content">
                         ...
                         <ul>
                             <li><i class="fa fa-fax"></i>آدرس: آدرس شما اینجاست.</li>
                             <li><i class="fa fa-phone"></i> <a href="#">demo@example.com</a></li>
                             <li><i class="fa fa-envelope-o"></i> 09121233223</li>
                         </ul>             
                     </div> 
                 </div>
                <div class="col-lg-6 col-md-12 text-end">
                    <div class="contact_message form">
                         <h3>پروژه خود را به ما بگویید</h3>   
                         <form id="contact-form" method="POST"  action="https://whizthemes.com/mail-php/jaber/contact.php">
                             <p>  
                                <label>نام شما (الزامی)</label>
                                 <input class="text-end" name="name" placeholder="*نام" type="text"> 
                             </p>
                             <p>       
                                <label>ایمیل شما (الزامی)</label>
                                 <input class="text-end" name="email" placeholder="*ایمیل" type="email">
                             </p>
                             <p>          
                                <label>  موضوع</label>
                                 <input class="text-end" name="subject" placeholder="*موضوع" type="text">
                             </p>    
                             <div class="contact_textarea">
                                 <label>پیغام شما</label>
                                 <textarea placeholder="*پیام" name="message"  class="form-control2 text-end" ></textarea>     
                             </div>   
