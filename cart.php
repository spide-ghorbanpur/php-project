...
<!-- Mirrored from template.hasthemes.com/reid/reid/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:10:43 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - سبد خرید</title>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product_name">تولید - محصول</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product_name"><a href="#">کیف دستی فرینگیلا</a></td>
                                            <td class="product-price">65.00 پوند</td>
                                            <td class="product_quantity"><input min="1" max="100" value="1"
                                                    type="number"></td>
                                            <td class="product_total">130.00 پوند</td>
                                        </tr>
                                        <tr>
                                            <td class="product_remove"><a href="#"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                            ...
                                            <td class="product_name"><a href="#">کیف های دستی فقط</a></td>
                                            <td class="product-price">90.00 پوند</td>
                                            <td class="product_quantity"><input min="1" max="100" value="1"
                                                    type="number"></td>
                                            <td class="product_total">180.00 پوند</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name"><a href="#">کیف دستی الیت</a></td>
                                            <td class="product-price">80.00 پوند</td>
                                            <td class="product_quantity"><input min="1" max="100" value="1"
                                                    type="number"></td>
                                            <td class="product_total">160.00 پوند</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 text-end">
                            <div class="coupon_code left">
                                ...
                                <div class="coupon_inner">
                                    <p>اگر کد کوپن خود را دارید وارد کنید.</p>
                                    <input class="text-end" placeholder="کد کوپن" type="text">
                                    <button type="submit">درخواست کوپن</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 text-end">
                            <div class="coupon_code right">
                                ...
                                <div class="coupon_inner">
                                    <div class="cart_subtotal">
                                        <p>جمع فرعی</p>
                                        <p class="cart_amount">215.00 پوند</p>
                                    </div>
                                    <div class="cart_subtotal ">
                                        <p>حمل دریایی</p>
                                        <p class="cart_amount"><span>نرخ ثابت:</span> 255.00 پوند</p>
                                    </div>
                                    <a href="#">محاسبه حمل و نقل</a>
