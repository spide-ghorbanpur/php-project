...
<!-- Mirrored from template.hasthemes.com/reid/reid/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:06:31 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - نوار کناری سمت چپ فروشگاه</title>
...
<body>
                                ...
                                <div class="main_menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="mega_items"><a href="shop.html">
                                                    <i class="fa fa-angle-down"></i>
                                                    خرید کنید
                                                    <ul class="mega_menu text-end">
                                                        ...
                                                        <li><a href="#">مجموعه</a>
                                                            <ul>
                                                                <li><a href="shop.html">کیف دستی</a></li>
                                                                <li><a href="shop.html">تجهیزات جانبی</a></li>
                                                                <li><a href="shop.html">تن پوش</a></li>
                                                                <li><a href="shop.html">کفش</a></li>
                                                                <li><a href="shop.html">شلوار را چک کنید</a></li>
    ...
    <div class="breadcrumbs_area text-end">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            <li>/</li>
                            <li>نوار کناری سمت چپ فروشگاه</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class=" niceselect_option">
                                ...
                                <form class="select_option" action="#">
                                    <select name="orderby" id="short">
                                        ...
                                        <option value="6">نام محصول: s</option>
                                    </select>
                                </form>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                        ...
                                        <div class="product_action">
                                            <div class="hover_action">
                                                ...
                                                <div class="action_button">
                                                    <ul>
                                                        <li><a title="اضافه به سبدخرید" href="cart.php"><i
                                    ...
                                    <div class="product_content grid_content">
                                        ...
                                        <span class="current_price"> پوند 60.00</span>
                                        <span class="old_price"> پوند 86.00</span>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        ...
                                        <div class="quick_button">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box" title="نمایش سریع">+ نمایش سریع</a>
                                        </div>
