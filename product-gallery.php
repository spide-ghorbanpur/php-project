...
<!-- Mirrored from template.hasthemes.com/reid/reid/product-gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:06:31 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - گالری محصولات</title>
...
<body>
                                                    ...
                                                    <ul class="mega_menu text-end">
                                                        ...
                                                        <li><a href="#">انواع محصول</a>
                                                            <ul>
                                                                ...
                                                                <li><a href="product-gallery.html">گالری محصولات</a>
                                                                </li>
    ...
    <div class="product_details gallery">
        <div class="container">
            <div class="row">
                    ...
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <div class="product_price">
                                <span class="current_price">70.00 پوند</span>
                                <span class="old_price">80.00 پوند</span>
                            </div>
                            <div class="product_desc">
                                <p>فضای بیشتری برای حرکت با 80 یا 160 گیگابایت فضای ذخیره سازی و تا 40 ساعت عمر باتری، آی پاد کلاسیک جدید به شما امکان می دهد تا از 40000 آهنگ یا حداکثر 200 ساعت ویدیو یا هر ترکیبی در هر کجا که هستید لذت ببرید. جریان پوششی. با ورق زدن آثار آلبوم، مجموعه موسیقی خود را مرور کنید. آلبومی را انتخاب کنید تا آن را برگردانید و لیست آهنگ را ببینید. رابط پیشرفته یک روش کاملاً جدید برای مرور و مشاهده موسیقی و ویدیوی خود را تجربه کنید. طراحی شیک تر. آی‌پاد کلاسیک زیبا، بادوام و شیک‌تر از همیشه، اکنون دارای آلومینیوم آنودایز شده و پولیش است.</p>
                            </div>
                            ...
                            <div class="product_variant size quantity ">
                                <h3 class="p-3">تعداد</h3>
                            ...
                            <div class=" product_d_action">
                               <ul>
                                   <li><a href="#" title="اضافه به علاقه مندی"><i class="fa fa-heart-o" aria-hidden="true"></i> به لیست آرزوها اضافه کنید</a></li>
                                   <li><a href="#" title="مقایسه محصول"><i class="fa fa-sliders" aria-hidden="true"></i> این محصول را مقایسه کنید</a></li>
                               </ul>
                            </div>
                    ...
                    <div class="product_d_inner">   
                        <div class="product_info_button text-end">    
                            <ul class="nav" role="tablist">
                                <li>
                                    <a class="active" data-bs-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="false">اطلاعات بیشتر</a>
                                </li>
                                <li>
                                     <a data-bs-toggle="tab" href="#sheet" role="tab" aria-controls="sheet" aria-selected="false">برگه داده</a>
                                </li>
                                <li>
                                   <a data-bs-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">بررسی ها</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                    <p>مد از سال 2010 مجموعه‌هایی با طراحی خوب ایجاد کرده است. این برند طرح‌های زنانه ارائه می‌دهد که لباس‌های مجزا و شیک ارائه می‌کنند که از آن زمان به یک مجموعه کاملاً آماده تبدیل شده‌اند که در آن هر کالا بخشی حیاتی از کمد لباس زنان است. نتیجه؟ ظاهری زیبا، آسان، شیک با ظرافت جوان پسند و استایل امضایی غیرقابل انکار. تمام قطعات زیبا در ایتالیا ساخته شده و با بیشترین توجه ساخته شده است. اکنون مد به طیف وسیعی از لوازم جانبی از جمله کفش، کلاه، کمربند و موارد دیگر گسترش یافته است!</p>
                                </div>    
                            </div>
