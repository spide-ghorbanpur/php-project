...
<!-- Mirrored from template.hasthemes.com/reid/reid/compare.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 09:11:12 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Reid - مقایسه کنید</title>
                    ...
                    <form action="#">
                        ...
                        <div class="compare-table table-responsive">
                            <table class="table mb-0">
                                <tbody>
                                    <tr>
                                        <td class="first-column">تولید - محصول</td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="assets/img/product/product4.jpg"
                                                    alt="Compare Product"></a>
                                            <a href="#" class="category">مبلمان</a>
                                            <a href="#" class="title">عنوان رینوسین</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="assets/img/product/product8.jpg"
                                                    alt="Compare Product"></a>
                                            <a href="#" class="category">مبلمان</a>
                                            <a href="#" class="title">عنوان ماکرو</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="assets/img/product/product9.jpg"
                                                    alt="Compare Product"></a>
                                            <a href="#" class="category">مبلمان</a>
                                            <a href="#" class="title">عنوان اوکلی</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="first-column">شرح</td>
                                        <td class="pro-desc">
                                            <p>عینک برای کسانی که در چشمانشان دشوار است هر لنگه را واضح و کامل ببینند
                                                بسیار مهم است</p>
                                        </td>
                                        <td class="pro-desc">
                                            <p>عینک برای کسانی که در چشمانشان دشوار است هر لنگه را واضح و کامل ببینند
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-price">295 دلار</td>
                                        <td class="pro-price">275 دلار</td>
                                        <td class="pro-price">395 دلار</td>
                                    </tr>
                                    <tr>
                                        <td class="first-column">رنگ</td>
                                        <td class="pro-color">مشکی</td>
                                        <td class="pro-color">مشکی</td>
                                        <td class="pro-color">مشکی</td>
                                    </tr>
                                    <tr>
                                        <td class="first-column">موجودی</td>
                                        <td class="pro-stock">در انبار</td>
                                        <td class="pro-stock">در انبار</td>
                                        <td class="pro-stock">در انبار</td>
                                    </tr>
                                    <tr>
                                        <td class="first-column">به سبد خرید اضافه کنید</td>
                                        <td class="pro-addtocart"><a href="#" class="add-to-cart"
                                                tabindex="0"><span>افزودن به سبد خرید</span></a></td>
                                        <td class="pro-addtocart"><a href="#" class="add-to-cart"
                                                tabindex="0"><span>افزودن به سبد خرید</span></a></td>
                                        <td class="pro-addtocart"><a href="#" class="add-to-cart"
                                                tabindex="0"><span>افزودن به سبد خرید</span></a></td>
                                    ...
                                    <tr>
                                        <td class="first-column">رتبه بندی</td>
